...
export default function CreateItem() {
  ...
  async function onChange(e) {
    ...
    try {
      //adding file to ipfs and getting url
  ...
  async function createSale(url) {
    ...
    const price = ethers.utils.parseUnits(formInput.price, 'ether') //getting price
    ...
    await transaction.wait()   //wait for transaction to finish and move to home page
    router.push('/')
  }
